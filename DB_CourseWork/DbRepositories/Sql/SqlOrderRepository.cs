...
{
    class SqlOrderRepository : IOrderStrategy
    {
        ...
        public void Add(Order entity)
        {
            ...
            {
                connection.Open();
                var command = new SqlCommand(@"INSERT INTO Orders (OrderCreatedTime, OrderBookingTime, OrderCancelledTime, OrderedCarId, OrderedHours, OrderPaymentId, IsCancelled) 
                                           VALUES (@OrderCreatedTime, @OrderBookingTime, @OrderCancelledTime, @OrderedCarId, @OrderedHours, @OrderPaymentId, @IsCancelled)", connection);
