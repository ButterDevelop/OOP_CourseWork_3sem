...
{
    internal class SqlCarRepository : ICarStrategy
    {
        ...
        public Car MapSqlReaderToObject(SqlDataReader reader)
        {
            return new Car
            {
                ...
                PricePerHour    = reader.GetFloat(reader.GetOrdinal("PricePerHour")),
                ...
                LocationX       = reader.GetFloat(reader.GetOrdinal("LocationX")),
                LocationY       = reader.GetFloat(reader.GetOrdinal("LocationY")),
