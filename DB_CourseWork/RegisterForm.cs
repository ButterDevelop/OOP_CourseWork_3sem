...
namespace DB_CourseWork
{
    partial class RegisterForm : Form
    {
        ...
        public RegisterForm(DatabaseContext dbContext)
        {
            InitializeComponent();
        ...
        private void textBoxUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBoxUsername.TextLength != 0 && _dbContext.GetAllUsers().FirstOrDefault(x => x.UserName == textBoxUsername.Text) is null)
            {
        ...
        private void textBoxEmail_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(_dbContext.GetAllUsers().FirstOrDefault(x => x.Email == textBoxEmail.Text) is null)) throw new Exception("This email is already taken.");
        ...
        private void maskedTextBoxPhoneNumber_TextChanged(object sender, EventArgs e)
        {
            ...
            if (r.IsMatch(maskedTextBoxPhoneNumber.Text) && _dbContext.GetAllUsers().FirstOrDefault(x => x.Phone == maskedTextBoxPhoneNumber.Text) is null)
            {
        ...
        private void buttonRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Client client = new Client(textBoxUsername.Text, textBoxPassword.Text, textBoxFullname.Text, textBoxEmail.Text, maskedTextBoxPhoneNumber.Text);
