...
namespace DB_CourseWork
{
    partial class AdminForm : Form
    {
        ...
        {
            labelFinancialReport_PotentionalSalary.Text = ((Admin)_dbContext.CurrentUser).GetPotentionalFinancialReport(dateTimePickerFinancialReport_FromDate.Value, dateTimePickerFinancialReport_ToDate.Value).ToString("N2").Replace(",", ".");
            labelFinancialReport_AvailableSalary.Text = ((Admin)_dbContext.CurrentUser).GetFinancialReport(dateTimePickerFinancialReport_FromDate.Value, dateTimePickerFinancialReport_ToDate.Value).ToString("N2").Replace(",", ".");
        }
        ...
        {
            labelSettings_WholeCarsServicedByThisAdmin.Text = ((Admin)_dbContext.CurrentUser).TotalCarsServiced.ToString();
        }
        ...
        private void buttonSettings_ChangePassword_Click(object sender, EventArgs e)
        {
            ...
            {
                _dbContext.Admins.Update((Admin)_dbContext.CurrentUser);
        ...
        public void RefreshUsersManagementList()
        {
            ...
            var users = _dbContext.GetAllUsers().OrderByDescending(x => x.Id);
        ...
        private void ListViewUsersManagement_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            if (listViewUsersManagement.SelectedItems.Count != 0)
            {
                ...
                var user = _dbContext.GetAllUsers().FirstOrDefault(x => x.Id == userId);
        ...
        private void buttonUsersManagement_SetRoleClient_Click(object sender, EventArgs e)
        {
            ...
            _dbContext.Employees.Delete(user.Id);
        ...
        private void buttonUsersManagement_SetRoleEmployee_Click(object sender, EventArgs e)
        {
            ...
            if (!(_dbContext.Payments.GetAll().FirstOrDefault(x => x.UserId == userId) is null))
            {
            ...
            _dbContext.Clients.Delete(user.Id);
        ...
        private void buttonUsersManagement_DeactivateThisAccount_Click(object sender, EventArgs e)
        {
            ...
            if (user.Role == RolesContainer.Employee)
            {
                ...
                _dbContext.Employees.Update((Employee)user);
            ...
            else
            {
                ...
                _dbContext.Clients.Update((Client)user);
        ...
        public void RefreshMakeServiceReport()
        {
            ...
            var cars = _dbContext.Cars.GetAll().OrderByDescending(x => x.Id).ToArray();
        ...
        private void ListViewMakeServiceReport_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            if (listViewMakeServiceReport.SelectedItems.Count != 0)
            {
                ...
                var car = _dbContext.Cars.GetAll().FirstOrDefault(x => x.Id == carId);
                ...
                if (comboBoxMakeServiceReport_AddOrEditCarMode.Text.Contains("Изменить"))
                {
                    ...
                    var findCar = _dbContext.Cars.Get(carId);
                    textBoxMakeMakeServiceReport_NewCarBrand.Text = findCar.Brand;
                    textBoxMakeMakeServiceReport_NewCarModel.Text = findCar.Model;
                    textBoxMakeMakeServiceReport_NewCarLicensePlate.Text = findCar.CarLicensePlate;
                    textBoxMakeMakeServiceReport_NewCarPricePerHour.Text = findCar.PricePerHour.ToString().Replace(",", ".");
                    textBoxMakeMakeServiceReport_NewCarProductionYear.Text = findCar.ProductionYear.ToString("yyyy");
                }
        ...
        private void buttonMakeServiceReport_SendToService_Click(object sender, EventArgs e)
        {
            ...
            ((Admin)_dbContext.CurrentUser).PutCarOnService(car, textBoxMakeMakeServiceReport_Description.Text);
            _dbContext.Admins.Update((Admin)_dbContext.CurrentUser);
        ...
        private void buttonMakeServiceReport_AddNewCar_Click(object sender, EventArgs e)
        {
            ...
            Car newCar = new Car(textBoxMakeMakeServiceReport_NewCarBrand.Text,
                                 textBoxMakeMakeServiceReport_NewCarModel.Text,
                                 textBoxMakeMakeServiceReport_NewCarLicensePlate.Text,
            ...
            if (!comboBoxMakeServiceReport_AddOrEditCarMode.Text.Contains("Добавить"))
            {
                ...
                var carToUpdate = _dbContext.Cars.Get(carId);
                carToUpdate.Brand = textBoxMakeMakeServiceReport_NewCarBrand.Text;
        ...
        public void RefreshServiceReportList()
        {
            ...
            var reports = _dbContext.ServiceReports.GetAll().OrderByDescending(x => x.StartedDate).ToArray();
        ...
        private void listViewServiceReportList_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            if (listViewServiceReportList.SelectedItems.Count != 0)
            {
                ...
                pictureBoxServiceReportList_CarPicture.Image  = new Bitmap(CarsOrderImages[servicedCar.Id], pictureBoxServiceReportList_CarPicture.Size);
